...
<main class="relative [&_.wp-block-column]:p-5 [&_.wp-block-column]:lg:p-10 [&_.wp-block-cover_.wp-block-button]:w-auto [&_.wp-block-group]:p-0 [&_.w-half]:w-full [&_.w-half]:lg:w-1/2">
    <?php
    if ($posts->have_posts()) :
